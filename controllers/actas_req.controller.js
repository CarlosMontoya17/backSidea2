...
exports.checkReqDesattend = async (req, res) => {
    ...
    await actas_req.findOne({ where: { [Op.and]: [{[Op.or]: [{comments: null}, {comments: ""}, {comments: " "}]}, {[Op.or]: [{robottaken: name}, {robottaken: null}]}], send: true }, attributes: ['id', 'type', 'metadata', 'id_req'], order: [['id', 'ASC']] }).then(data => {
        if(data != null){
